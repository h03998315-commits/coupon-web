...
.boot-text{margin-top:18px;text-align:center;line-height:1.6}
...
.copy{text-align:center;margin-top:6px;color:#00ffa6;font-size:14px}
...
<div id="boot">
  ...
  <div class="boot-text">
    INITIALIZING…<br>
    <strong>SHEIN COUPON SHOP</strong><br>
    SYSTEM ONLINE
  </div>
</div>
...
<script>
// Always hide boot after fixed time (NO race conditions)
setTimeout(() => {
